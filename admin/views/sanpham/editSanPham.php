  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        ...
        <div class="col-1">
          <a href="<?= BASE_URL_ADMIN . '?act=san-pham' ?>" class="btn btn-secondary">Quay lại<i class="far fa-hand-point-left"></i></a>
        </div>
      </div>
    </div><!-- /.container-fluid -->
  </section>
...
<script>
  ...
  function addfaqs() {
    ...
    html += '<td><img src="iphone-16-pro-titan-tu-nhien.png" style="width: 50px; height: 50px;" alt=""></td>';
